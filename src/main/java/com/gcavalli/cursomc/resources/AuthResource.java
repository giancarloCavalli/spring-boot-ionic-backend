...
import com.gcavalli.cursomc.dto.EmailDTO;
import com.gcavalli.cursomc.security.JWTUtil;
import com.gcavalli.cursomc.security.UserSS;
import com.gcavalli.cursomc.services.AuthService;
...
public class AuthResource {
	...
	public ResponseEntity<Void> refreshToken(HttpServletResponse response) {
		...
		response.addHeader("access-control-expose-headers", "Authorization"); //liberação de acesso a requisições externas referente ao CORS
